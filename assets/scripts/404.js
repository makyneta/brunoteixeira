/* -------------------------------------------------
   ...
   (incorporado aqui para que a 404 funcione sem arquivos externos)
------------------------------------------------- */
/* -------------------------------------------------
   particles.js – motor de partículas minimalista
...
/* -------------------------------------------------
   404.js – redirecionamento automático (opcional)
------------------------------------------------- */
(() => {
    const AUTO_REDIRECT_SECONDS = 0;   // 0 = desativado; troque para 10, 5, etc.
